...
public class CategoryServiceImpl implements CategoryService {
	...
	@Override
	public ResponseEntity<String> delete(String Value) {
		            categoryDao.delete(categoryDao.findById(Integer.parseInt(Value)).get());
                    return CafeUtils.getResponeEntity("Category Delete Successfully", HttpStatus.OK);
